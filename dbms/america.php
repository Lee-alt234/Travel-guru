...
// Fetch all hotels from the 'america' table
...
<h1 style="text-align: center; margin: 30px;">Available Hotels in America</h1>
        ...
        while($row = $result->fetch_assoc()) {
            echo '<div class="hotel-box">
                    ...
                    <div class="hotel-info">
                        ...
                        <a href="booking.php?hotel_name=' . urlencode($row['hotel']) . '&table=america" class="book-now-btn">Book Now</a>
                    </div>
                </div>';
        }
    } else {
